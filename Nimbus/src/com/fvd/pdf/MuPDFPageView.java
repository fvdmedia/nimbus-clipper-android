...
public class MuPDFPageView extends PageView implements MuPDFView {
	...
	private AsyncTask<pdfShape[],Void,Void> mAddInk;
	...
	public String passNoteClick(float x, float y) {
		String result="";
		float scale = mSourceScale*(float)getWidth()/(float)mSize.x;
		...
		if (mAnnotations != null) {
			...
			if (hit) {
				...
				case TEXT:
					...
					//Annotation a=mAnnotations[i];
					//Log.e("annotation", a.text);
					return mAnnotations[i].text;
				}
			}
		}
		return result;
	...
	public boolean saveDraw() {
		...
		mAddInk = new AsyncTask<pdfShape[],Void,Void>() {
			@Override
			protected Void doInBackground(pdfShape[]... params) {
