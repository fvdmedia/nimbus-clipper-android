...
public class AmbilWarnaDialog {
	...
	/*final SeekBar seekLine;
	final TextView textLine;
	final SeekBar seekType;
	...
	public AmbilWarnaDialog(final Context context, int color, boolean supportsAlpha, OnAmbilWarnaListener listener) {
		...
		/*seekLine=(SeekBar)view.findViewById(R.id.seekBarLine);
		textLine=(TextView)view.findViewById(R.id.tvLineWidth);
		seekLine.setOnSeekBarChangeListener(new OnSeekBarChangeListener(){

			@Override
			public void onProgressChanged(SeekBar arg0, int progress, boolean fromUser) {
				// TODO Auto-generated method stub
				lineWidth = progress/10;
				textLine.setText(String.format("%d",lineWidth));
			}
		...
		seekType=(SeekBar)view.findViewById(R.id.seekBarType);
		textType=(TextView)view.findViewById(R.id.tvTextType);
		seekType.setOnSeekBarChangeListener(new OnSeekBarChangeListener(){

			@Override
			public void onProgressChanged(SeekBar arg0, int progress, boolean fromUser) {
				// TODO Auto-generated method stub
				textSize=40+progress*2;
				textType.setText(String.format("%d",textSize));
			}
