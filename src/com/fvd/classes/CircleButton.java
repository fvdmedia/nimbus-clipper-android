...
public class CircleButton extends ImageView {
	...
	private static final int PRESSED_RING_ALPHA = 200;
	...
	protected void onDraw(Canvas canvas) {
		canvas.drawCircle(centerX, centerY, pressedRingRadius, focusPaint);
		//canvas.drawCircle(centerX, centerY, pressedRingRadius + animationProgress, focusPaint);
		canvas.drawCircle(centerX, centerY, outerRadius - pressedRingWidth-4, circlePaint);
		super.onDraw(canvas);
	}
	...
	public void setColor(int color) {
		...
		focusPaint.setColor(Color.WHITE/*defaultColor*/);
