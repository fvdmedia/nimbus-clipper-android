...
public class MuPDFCore
{
	...
	private native void addDrawAnnotationInternal(PointF[][] arcs, int type, int c);
	private native void addTextAnnotationInternal(String jText, float x, float y);
	...
	public synchronized void addDrawAnnotation(int page, PointF[][] arcs, Annotation.Type type, int c) {
		gotoPage(page);
		addDrawAnnotationInternal(arcs,type.ordinal(), c);
	}
	
	public synchronized void addTextAnnotation(int page, String text, float x, float y) {
		gotoPage(page);
		addTextAnnotationInternal(text,x,y);
	}
